      ...
      <div style={{ maxWidth: '560px', width: '100%' }}>
        ...
        <div style={{ background: cardBg, borderRadius: '20px', border: `1px solid ${borderColor}`, overflow: 'hidden' }}>
          ...
          <div style={{ padding: '28px' }}>
            ...
            {/* Property */}
            <div style={{ background: darkMode ? '#0f172a' : '#FAF8F4', borderRadius: '12px', padding: '16px', marginBottom: '20px' }}>
            ...
            {/* Payment method */}
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '12px', background: darkMode ? '#0f172a' : '#FAF8F4', borderRadius: '10px', marginBottom: '20px' }}>
